...
export const resourceApi = {
  ...
  updateProgramObjectiveWeights: (schoolYearID: string, programID: string, value: ObjectiveWeightsInput) => unwrap(api.PUT('/api/school-years/{schoolYearID}/programs/{programID}/objective-weights', { params: { path: { schoolYearID, programID }, body: value } })),
