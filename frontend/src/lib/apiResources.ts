...
export const resourceApi = {
  ...
  transitionSession: (schoolYearID: string, programID: string, sessionID: string, value: Schemas['TransitionSessionInputBody']) => unwrap(api.POST('/api/school-years/{schoolYearID}/programs/{programID}/sessions/{sessionID}/transition', { params: { path: { schoolYearID, programID, sessionID } }, body: value })),
  getCatalogFeasibility: (schoolYearID: string, programID: string, sessionID: string) => unwrap(api.GET('/api/school-years/{schoolYearID}/programs/{programID}/sessions/{sessionID}/catalog-feasibility', { params: { path: { schoolYearID, programID, sessionID } } })),
  ...
  listSessionNonParticipations: (schoolYearID: string, programID: string, sessionID: string) => unwrapList(api.GET('/api/school-years/{schoolYearID}/programs/{programID}/sessions/{sessionID}/non-participations', { params: { path: { schoolYearID, programID, sessionID } } })),
  createSessionNonParticipation: (schoolYearID: string, programID: string, sessionID: string, value: Schemas['CreateSessionNonParticipationInputBody']) => unwrap(api.POST('/api/school-years/{schoolYearID}/programs/{programID}/sessions/{sessionID}/non-participations', { params: { path: { schoolYearID, programID, sessionID } }, body: value })),
  updateSessionNonParticipation: (schoolYearID: string, programID: string, sessionID: string, nonParticipationID: string, value: Schemas['UpdateSessionNonParticipationInputBody']) => unwrap(api.PATCH('/api/school-years/{schoolYearID}/programs/{programID}/sessions/{sessionID}/non-participations/{nonParticipationID}', { params: { path: { schoolYearID, programID, sessionID, nonParticipationID } }, body: value })),
  deleteSessionNonParticipation: (schoolYearID: string, programID: string, sessionID: string, nonParticipationID: string) => unwrapNoContent(api.DELETE('/api/school-years/{schoolYearID}/programs/{programID}/sessions/{sessionID}/non-participations/{nonParticipationID}', { params: { path: { schoolYearID, programID, sessionID, nonParticipationID } } })),
  ...
  updateProgramObjectiveWeights: (schoolYearID: string, programID: string, value: ObjectiveWeightsInput) => {
    const options = { params: { path: { schoolYearID, programID } }, body: value }
    return unwrap(api.PATCH('/api/school-years/{schoolYearID}/programs/{programID}/objective-weights', options))
  },
  ...
  updateSessionObjectiveWeights: (schoolYearID: string, programID: string, sessionID: string, value: Schemas['UpdateSessionObjectiveWeightsInputBody']) => {
    const options = { params: { path: { schoolYearID, programID, sessionID } }, body: value }
    return unwrap(api.PATCH('/api/school-years/{schoolYearID}/programs/{programID}/sessions/{sessionID}/objective-weights', options))
  },
