      ...
      >
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            {description && (
              <p className="mt-1 text-sm text-muted-foreground" id="modal-form-description">
                {description}
              </p>
            )}
          </div>
          <button
            ...
            className="rounded-md px-2 py-1 text-lg leading-none text-muted-foreground hover:bg-accent hover:text-foreground"
