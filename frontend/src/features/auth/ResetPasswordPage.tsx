  ...
  return (
    <AuthLayout>
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        We’ll email a reset link to your administrator account.
      </p>
      <div className="mt-6 space-y-3">
        ...
        {sent && (
          <p
            ...
            role="status"
          >
            If that address is an administrator account, a reset link is on its way.
          </p>
        )}
      </div>
