...
func registerOperations(api huma.API, options RouterOptions) {
	...
	registerOperation(api, huma.Operation{OperationID: "regenerate-interest-profile-survey-codes", Method: http.MethodPost, Path: apiBasePath + "/school-years/{schoolYearID}/programs/{programID}/interest-profile-surveys/{surveyID}/regenerate-codes", Summary: "Regenerate interest-profile survey access codes", Errors: []int{http.StatusConflict, http.StatusNotFound}}, auth.CapabilityManageRoster, false, programs.RegenerateInterestProfileSurveyCodes)
